 ...
 * @brief Unit tests for firmware communication — V2 Binary Protocol + Legacy Protocol
 */
...
#include "firmware/LegacyGrblProtocol.hpp"

using namespace robot_controller::firmware;

// ============================================================================
// Legacy Protocol Tests (from LegacyGrblProtocol.hpp)
// ============================================================================
